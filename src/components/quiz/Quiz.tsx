        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-2">
            {q.options.map((option, i) => {
              ...
              if (state !== 'idle') {
                if (i === q.correctIndex) {
                  optStyle = 'border-emerald-400 bg-emerald-50 text-emerald-800 dark:border-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-300';
                } else if (i === selected && i !== q.correctIndex) {
                  optStyle = 'border-red-400 bg-red-50 text-red-800 dark:border-red-700 dark:bg-red-950/40 dark:text-red-300';
                } else {
                  optStyle = 'border-gray-200 bg-white text-gray-400 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-600';
                }
              } else if (selected === i) {
                optStyle = 'border-indigo-400 bg-indigo-50 text-indigo-800 dark:border-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-300';
              }
              return (
                <button
                  key={i}
                ...
                >
                  ...
                  >
                    {state !== 'idle' && i === q.correctIndex ? '✓' : state !== 'idle' && i === selected && i !== q.correctIndex ? '✗' : String.fromCharCode(65 + i)}
                  </span>
                  {option}
                </button>
              );
